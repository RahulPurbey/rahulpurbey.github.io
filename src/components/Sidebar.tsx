  ...
  return (
    <aside className="w-64 bg-sidebar h-screen flex flex-col fixed left-0 top-0">
      ...
      <nav className="flex-1 py-4">
        ...
        <NavItem icon={<BookOpen className="w-5 h-5" />} label="Manage Books" />
        <NavItem icon={<ArrowLeftRight className="w-5 h-5" />} label="Issue & Return" />
      ...
      <div className="p-4 border-t border-sidebar-border">
        <button className="flex items-center gap-2 px-4 py-2 text-sidebar-foreground bg-sidebar-primary/20 hover:bg-sidebar-primary/30 rounded-md transition-colors text-sm font-medium">
